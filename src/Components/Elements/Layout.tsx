...
const Layout = ({ children }: any) => {
  ...
  return (
    <>
      <aside
        id="logo-sidebar"
        className="fixed pb-5  hidden sm:flex justify-between flex-col rounded-lg top-0 sm:m-6 left-0 side-color z-40 w-[300px]  sm:w-[100px] lg:w-[310px] h-[93vh]  transition-transform sm:translate-x-0 "
        aria-label="Sidebar"
      >
        <div className="">
          <a
              ...
              <div>
                <div className="flex-row flex items-center">
                  <div className="flex items-center justify-center bg-[#5e2991] text-white w-[33px] h-[33px] rounded-full">
                    <p className="text-white font-bold leading-4 font-sans">
                      M
                    </p>
                  </div>
        ...
        <div className="mx-4 flex self-end gap-6 mt-4">
          <div
      ...
      <div className="w-[100%] sm:hidden mx-auto ">
        ...
        <div
          className={`relative z-0 ${
            toggal ? "blur-sm pointer-events-none" : ""
          }`}
        >
          <div
            className={`rounded-lg mx-4 mt-24 side-color ${
              toggal ? "overflow-hidden" : ""
            }`}
          >
            {children}
          </div>
